                ...
                <div class="table-responsive">
                    <table class="table zero-configuration">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$x}}</td>
                                <td><img src="{{asset('upload/logo/'.$header->image)}}" width="150" alt=""></td>


                                <td>


                                    <a href="{{url('admin/edit_logo/'.$header->id)}}" class="btn btn-primary ml-lg-1 ml-md-1 mt-1" ><i class="feather icon-edit"></i> Edit</a>
